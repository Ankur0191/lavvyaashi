...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    toast.success("Welcome back to Lavvyaashi");
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-serif text-text">Sign In</h2>
        <p className="text-sm text-text-muted mt-1">Access your luxury beauty account.</p>
      </div>
      ...
      <div className="mt-6 text-center text-sm text-text-muted">
        ...
        <Link href={`/signup?redirect=${encodeURIComponent(redirectUrl)}`} className="text-gold hover:underline font-medium">
          Create an account
        </Link>
      </div>
    </div>
